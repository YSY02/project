...
public class MultipleThreadCatch {
    ...
    public static void main(String[] args) throws IOException, NoSuchAlgorithmException, InterruptedException {
        ...
        client.getOptions().setCssEnabled(false);
        client.getOptions().setJavaScriptEnabled(false);
        //一直Exception in thread "main" com.gargoylesoftware.htmlunit.FailingHttpStatusCodeException: 500 Internal Server Error for https://so.gushiwen.org/gushi%20/tangshi.aspx 	at com.gargoylesoftware.htmlunit.WebClient.throwFailingHttpStatusCodeExceptionIfNecessary
        //加入
        ...
        //1.列表页的解析
        {
            String url=baseUrl+pathUr1;//列表页网址
            HtmlPage page=client.getPage(url);
            ...
            for (HtmlElement div:divs){
                ...
                for (HtmlElement a:as) {
                    String detailUrl = a.getAttribute("herf");
                    detailUrlList.add(baseUrl+detailUrl);//一个详情页:https://so.gushiwen.org/shiwenv_45c396367f59.aspx
                }
            }
        }
